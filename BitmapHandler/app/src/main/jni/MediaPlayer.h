...
GoogleGitSign in
android / platform/frameworks/base / 56a2301 / . / media / jni / android_media_MediaPlayer.cpp
blob: 5408a1f0ceaee9f138afa38383cb298eb5b2b4cb [file] [log] [blame]
/*
**
...
static void
android_media_MediaPlayer_setDataSourceAndHeaders( JNIEnv *env, jobject thiz, jstring path, jobjectArray keys, jobjectArray values) {
    sp<MediaPlayer> mp = getMediaPlayer(env, thiz);
    if (mp == NULL ) {
        jniThrowException(env, "java/lang/IllegalStateException", NULL);
        return;
